...
function leerDatosCurso(curso) {
  ...
  // Revisamos si el curso ya existe en el carrito. Podemos usar some, recordemos que lo que hace es iterar sobre el array de objetos y devolvernos si el elemento existe o no.
